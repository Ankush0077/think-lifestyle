...
// Plasmic Project: mmERTXeanX9cNoarguu1SN
// Component: bgCAi_sGQslR
...
import projectcss from "./plasmic.module.css"; // plasmic-import: mmERTXeanX9cNoarguu1SN/projectcss
import sty from "./PlasmicButton2.module.css"; // plasmic-import: bgCAi_sGQslR/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: AkTLK6hl0SkF/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: 8px8bU7zvOsb/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__suudy)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg__rmpBs)}
                role={"img"}
              />
            ),
